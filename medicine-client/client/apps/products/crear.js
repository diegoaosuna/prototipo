...
exports.main = async function main(id,nombre,descripcion,fecha,usuario,comentario,propietario,estado) {
    try {
	...
	const walletPath  = '/prototipo/medicine-client/client/apps/wallet-org2';
        ...
        const contract = network.getContract('products-contract');

        // Evaluate the specified transaction.
        // txnEnviarListaMedicinas transaction - requires 1 argument, ex: ('txnEnviarListaMedicinas', '[01,02]')
        const result = await contract.submitTransaction('crear',id,nombre,descripcion,fecha,usuario,comentario,propietario,estado);
