...
exports.main = async function main(list) {
	...
	const wallet = new FileSystemWallet(walletPath);
        ...
        // txnVenderListaMedicinas transaction - requires 1 argument, ex: ('txnVenderListaMedicinas', '[01,02]')
        const result = await contract.submitTransaction('txnVenderListaMedicinas',list);
