...
exports.main = async function main() {
	try {
        ...
        const caURL = ccp.certificateAuthorities['ca4.prototipo.com'].url;
        ...
        if (adminExists) {
            console.log('An identity for the admin user "admin" already exists in the wallet-org4');
            return;
        }
        ...
        console.log('Successfully enrolled admin user "admin" and imported it into the wallet-org4');
