...
exports.main = async function main(list) {
	...
	const wallet = new FileSystemWallet(walletPath);
        ...
        // txnEntregarListaMedicinas transaction - requires 1 argument, ex: ('txnEntregarListaMedicinas', '[01,02]')
        const result = await contract.submitTransaction('txnEntregarListaMedicinas',list);
