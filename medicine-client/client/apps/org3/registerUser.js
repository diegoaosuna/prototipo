...
exports.main = async function main() {
    try {
        ...
        const walletPath = path.resolve('/prototipo/medicine-client/client/apps/wallet-org3');
        ...
        if (userExists) {
            console.log('An identity for the user "user1" already exists in the wallet-org3');
            return;
        }
        ...
        if (!adminExists) {
            console.log('An identity for the admin user "admin" does not exist in the wallet-org3');
	...
	let affiliationService = ca.newAffiliationService();
        ...
        if(!registeredAffiliations.result.affiliations.some(x => x.name == 'org3')){
	let affiliation = 'org3.department1'; 
        ...
        console.log('Successfully registered and enrolled admin user "user1" and imported it into the wallet-org3');
