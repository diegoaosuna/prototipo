...
exports.main = async function main(id,name,description) {
    try {
	...
	const walletPath = '/prototipo/medicine-client/client/apps/wallet-org1';
        ...
        // txnCrearMedicina transaction - requires 1 argument, ex: ('queryCar', '01','acetaminofen','Tabletas x12')
        const result = await contract.submitTransaction('txnCrearMedicina',id,name,description);
