...
exports.main = async function main(list) {
	...
	const walletPath  = '/prototipo/medicine-client/client/apps/wallet-org1';
        ...
        // txnDistribuirListaMedicinas transaction - requires 1 argument, ex: ('queryCar', '[01,02]')
        const result = await contract.submitTransaction('txnDistribuirListaMedicinas',list);
